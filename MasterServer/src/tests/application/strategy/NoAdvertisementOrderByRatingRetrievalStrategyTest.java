...
public class NoAdvertisementOrderByRatingRetrievalStrategyTest extends RetrievalStrategyTest {
	public void testRetrieve() {
		try {
			...
			NoAdvertisementOrderByRatingRetrievalStrategy s = new NoAdvertisementOrderByRatingRetrievalStrategy();
