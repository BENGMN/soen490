...
public class AllOrderByRatingRetrievalStrategyTest extends RetrievalStrategyTest {
	...
	public void testRetrieve() {
		try {
			...
			AllOrderByRatingRetrievalStrategy s = new AllOrderByRatingRetrievalStrategy();
