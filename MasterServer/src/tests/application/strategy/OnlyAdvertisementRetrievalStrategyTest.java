...
public class OnlyAdvertisementRetrievalStrategyTest extends	RetrievalStrategyTest {
	public void testRetrieve() {
		try {
			...
			OnlyAdvertisementRetrievalStrategy s = new OnlyAdvertisementRetrievalStrategy();
