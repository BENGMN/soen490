...
public class NoAdvertisementOrderByDateRetrievalStrategyTest extends RetrievalStrategyTest {
	public void testRetrieve() {
		try {
			...
			NoAdvertisementOrderByDateRetrievalStrategy s = new NoAdvertisementOrderByDateRetrievalStrategy();
