...
public class MessageFinder {
	...
	public static ResultSet findByTimeAndRatingToPurge(final int DAYS_OF_GRACE) throws SQLException {
	...
	/*
	 * The Finder methods below find return message ids based on longitude/latitude and a radius. Some are limited to returning a max amount.
	 */	
